...
import { faFlagCheckered, faUsers, faCheckToSlot, faChartPie } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <section className='my-12'>
            <div className="container mx-auto p-4">
                <div className="top-text mb-8 text-center">
